...
class App extends React.Component {
    ...
    render() {
        ...
        >
            {/* Viewport */}
            {/*<div style={{ position: 'absolute', width: '100%', height: '100%', boxSizing: 'border-box', border: '1px dashed blue', transform: `translate(${(x - 0.5) * 500}px, ${(y - 0.5) * 500}px) scale(${1 / scale})` }} />
